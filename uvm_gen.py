...
# \s*\((?:\s*\.(?:\s*\b[a-zA-Z_][a-zA-Z0-9_$]*\b\s*)\s*\(.*?(?=\s*\)\s*,\)\s*,)*?\s*(?:\.(?:\s*\b[a-zA-Z_][a-zA-Z0-9_$]*\b\s*)\s*\(.*?(?=\s*\)\s*,\)\s*)\s*\)\s*


# \s*\((?:\s*\.(?:\s*\b[a-zA-Z_][a-zA-Z0-9_$]*\b\s*)\s*\(.*?(?=\)\s*,)\)\s*,)*\s*\)


"\s*\((?:\s*\.(?:\s*\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b\s*)\s*\(.*?(?=\)\s*,)\)\s*,)*\s*(?:\s*\.(?:\s*\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b\s*)\s*\(.*?(?=\)\s*\))\)\s*\))\s*;\s*"

# \s*\((?:\s*\.(?:\s*\b[a-zA-Z_][a-zA-Z0-9_$]*\b\s*)\s*\(.*?(?=\)\s*,)\)\s*,)*\s*(?:\s*\.(?:\s*\b[a-zA-Z_][a-zA-Z0-9_$]*\b\s*)\s*\(.*?(?=\)\s*\))\)\s*\))\s*\s*

str2 = "\s*\((?:(?:.*?)(?=,)\s*)*?(?:(?:.*?))(?=\)\s*)\s*\)\s*"
    # str1 = "\s*\((?:\s*\.(?:\s*\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b\s*)\s*\(.*?(?=\s*\)\s*,\)\s*,)*?\s*(?:\.(?:\s*\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b\s*)\s*\(.*?(?=\s*\)\s*,\)\s*)\s*\)\s*"
...
str7 = "(\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b)\s*" + str3 + "(\\b[a-zA-Z_][a-zA-Z0-9_$]*\\b)\s*" + str
# result = re.findall(str6, str,flags=re.S)
a= 0